        ...
        <div class="insider">
            ...
            <h1>Vehicles Details</h1>
                ...
                <table border="1px solid" style="margin-left: 30px;">
                    ...
                    ?>
                        <tr>
                            <th><input type="text" disabled id="VehicleNo<?php echo $CUST_DATA["Vehicle_No"] ?>" value="<?php echo $CUST_DATA["Vehicle_No"] ?>"></th>
                            <th><input type="text" id="Engine_No<?php echo $CUST_DATA["Vehicle_No"] ?>" value="<?php echo $CUST_DATA["Engine_No"] ?>"></th>
                            <th><input type="text" id="Chasis_No<?php echo $CUST_DATA["Vehicle_No"] ?>" value="<?php echo $CUST_DATA["Chasis_No"] ?>"></th>
                            <th><input disabled type="text" id="Chasis_No<?php echo $CUST_DATA["Vehicle_No"] ?>" value="<?php echo $CUST_DATA["cus_nic"] ?>"></th>
