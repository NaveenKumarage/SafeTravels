        ...
        <div class="insider">
            ...
            <div style="margin-top: 150px;">
                ...
                <table border="1px solid" style="margin-left:2px;">
                    ...
                    ?>
                        <tr>
                            <th><input type="text" disabled id="nic<?php echo $CUST_DATA["NIC"] ?>" value="<?php echo $CUST_DATA["NIC"] ?>"></th>
                            <th><input type="text" id="name<?php echo $CUST_DATA["NIC"] ?>" value="<?php echo $CUST_DATA["Full_Name"] ?>"></th>
                            <th><input type="text" id="email<?php echo $CUST_DATA["NIC"] ?>" value="<?php echo $CUST_DATA["Email"] ?>"></th>
                            <th><input type="text" id="mobile<?php echo $CUST_DATA["NIC"] ?>" value="<?php echo $CUST_DATA["Phone_number"] ?>"></th>
                            <th><input type="text" id="address<?php echo $CUST_DATA["NIC"] ?>" value="<?php echo $CUST_DATA["Address"] ?>"></th>
