...
function UpdatePassword(){
 ...
 function DeleteCustomer(NIC){
    ...
    r.onreadystatechange = function (){
        if(r.readyState == 4 && r.status == 200){
            alert(r.responseText);
            window.location.reload(); // web page eka reload karagannawa
        }
    }
 ...
 function createAccount(){
    ...
    r.onreadystatechange = function (){
        if(r.readyState == 4 && r.status == 200){
            ...
            alert(r.responseText); // signup Success
 ...
 function UpdateVehicle(vehicleNo){
    ...
    var vehicleNo = document.getElementById("VehicleNo"+vehicleNo).value;
    var Engine_No = document.getElementById("Engine_No"+vehicleNo).value;
    var Chasis_No = document.getElementById("Chasis_No"+vehicleNo).value;
 ...
 function  UpdateCustomer(NIC){
    ...
    var address = document.getElementById("address"+NIC).value;
    var name = document.getElementById("name"+NIC).value;
    var email = document.getElementById("email"+NIC).value;
    var mobile = document.getElementById("mobile"+NIC).value;
